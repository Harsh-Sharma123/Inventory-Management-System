...
class product:
    def __init__(self, root):
        ...
        # ======= Buttons ==========
        btn_add = Button(product_frame, text="Save", command=self.add, font=("oudy old style", 15), bg="#2196f3", fg="white", cursor='hand2').place(x=10, y=400, width=100, height=40)
        btn_update = Button(product_frame, text="Update", command=self.update, font=("oudy old style", 15), bg="#4caf50", fg="white", cursor='hand2').place(x=120, y=400, width=100, height=40)
        btn_delete = Button(product_frame, text="Delete", font=("oudy old style", 15), command=self.delete, bg="#f44336", fg="white", cursor='hand2').place(x=230, y=400, width=100, height=40)
        btn_clear = Button(product_frame, text="Clear", command=self.clear, font=("oudy old style", 15), bg="#607f8b", fg="white", cursor='hand2').place(x=340, y=400, width=100, height=40)
    ...
    def add(self):
        ...
        try:
            if self.var_cat.get() == "Select" or self.var_cat.get()=="Empty" or self.var_sup.get()=="Select" or self.var_name.get()=="":
                ...
                row = cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","Product already present, try different one.")
                else:
